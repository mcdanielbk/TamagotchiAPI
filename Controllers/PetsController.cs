...
namespace TamagotchiAPI.Controllers
{
    ...
    public class PetsController : ControllerBase
    {
        ...
        public async Task<ActionResult<Playtime>>CreatePlaytimeForGame(int id, Playtime playtime)
        {
             var pet = await _context.Pets.FindAsync(id);
        ...
        public async Task<ActionResult<Scolding>>CreateScoldingForGame(int id, Scolding scolding)
        {
             var pet = await _context.Pets.FindAsync(id);
